...
function cargarModuloAlimentos() {
    fetch("../../modules/moduloCatalogoAlimentos/addAlimentos.html")
        .then(
            function (response) {
        ...
        .then(
            function (html) {
                document.getElementById("contenedorPrincipal").innerHTML = html;
                import("viewALimentos.html").then(
                    function (controller) {
...
function agregarSucursal() {
    fetch("../../modules/moduloSucursal/viewSucursal.html")
        ...
        .then(
            function (html) {
                document.getElementById("contenedorPrincipal").innerHTML = html;
                import("../../modules/moduloSucursal/controllerSucursal.js").then(
                    function (controller) {
                        agregarSucursal = controller;
                    }
                );
            }
        );
